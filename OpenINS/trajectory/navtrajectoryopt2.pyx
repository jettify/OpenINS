#from trajectory.navtrajectorycf cimport cube
#
...
##from trajectory.navtrajectory_c_f cimport phi as cphi
##from trajectory.navtrajectory_c_f cimport PathParam
##
...
#
#
##cdef double phi(double t, PathParam pd):
##    return pd.k11 + pd.k12*t + pd.k13*sin(pd.k15 + pd.k14*t)
##
